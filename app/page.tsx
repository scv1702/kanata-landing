  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-stretch gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              ...
              <div className="flex flex-col h-full justify-start items-start space-y-4 bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold">{t("features.contextual.title")}</h3>
                  <p className="text-muted-foreground">{t("features.contextual.description")}</p>
                </div>
              </div>
              ...
              <div className="flex flex-col h-full justify-start items-start space-y-4 bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold">{t("features.progressive.title")}</h3>
                  <p className="text-muted-foreground">{t("features.progressive.description")}</p>
                </div>
              </div>
              ...
              <div className="flex flex-col h-full justify-start items-start space-y-4 bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold">{t("features.live.title")}</h3>
                  <p className="text-muted-foreground">{t("features.live.description")}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Final CTA Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 border-t" ref={emailInputRef}>
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
              ...
              <div className="mx-auto w-full max-w-md space-y-2">
                <EmailForm />
                <p className="text-xs text-muted-foreground text-center">{t("cta.noCreditCard")}</p>
              </div>
            </div>
          </div>
        </section>
